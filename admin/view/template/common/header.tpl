...
<script type="text/javascript" src="view/javascript/summernote/renderer.js"></script>
<script type="text/javascript" src="view/javascript/summernote/plugin/summernote-ext-emoji.js"></script>
  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://www.mada.ninja" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="http://docs.mada.ninja" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="http://forum.mada.ninja" target="_blank"><?php echo $text_support; ?></a></li>
      </ul>
    </li>
