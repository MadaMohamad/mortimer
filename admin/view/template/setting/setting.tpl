      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-local" data-toggle="tab"><?php echo $tab_language; ?></a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-about"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_about; ?>"><?php echo $entry_about; ?></span></label>
                <div class="col-sm-10">
                  <textarea name="config_about" rows="5" placeholder="<?php echo $entry_about; ?>" id="input-about" class="form-control"><?php echo $config_about; ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-catalog-limit"><span data-toggle="tooltip" title="<?php echo $help_post_limit; ?>"><?php echo $entry_post_limit; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_post_limit" value="<?php echo $config_post_limit; ?>" placeholder="<?php echo $entry_post_limit; ?>" id="input-catalog-limit" class="form-control" />
                    <?php if ($error_post_limit) { ?>
                    <div class="text-danger"><?php echo $error_post_limit; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-list-description-limit"><span data-toggle="tooltip" title="<?php echo $help_post_description_length; ?>"><?php echo $entry_post_description_length; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_post_description_length" value="<?php echo $config_post_description_length; ?>" placeholder="<?php echo $entry_post_description_length; ?>" id="input-list-description-limit" class="form-control" />
                    <?php if ($error_post_description_length) { ?>
                    <div class="text-danger"><?php echo $error_post_description_length; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_post_width" value="<?php echo $config_image_post_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-post-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_post_height" value="<?php echo $config_image_post_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
