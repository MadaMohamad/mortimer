...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 latest">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 image"><a href="<?php echo $post['href']; ?>"><img class="latest" src="<?php echo $post['thumb']; ?>" alt="<?php echo $post['name']; ?>" title="<?php echo $post['name']; ?>" class="img-responsive" /></a></div>
